...
const Extraction = (props: any, ref) => {
  ...
  useEffect(() => {
    // if (Object.keys(props.fileReader.updatedSection).length>0) {
    //    const newLabels = props.fileReader.updatedSection[key][activeSection][0].comprehendMedical[entity].label
    // console.log(newLabels)
    //   setLabels(newLabels)
    //   setWordsCollection(newLabels)
    // }
     
   
    
  },[props.fileReader.updatedSection])
  ...
  useEffect(() => {
    ...
    // const labels=file[key][activeSection][0].comprehendMedical[entity].label
  // console.log('===', labels)
    const paramBody = {
      [key]: {
        [activeSection]: [
  ...
  useEffect(() => {
    ...
    console.log('----', props.fileReader.updatedSection)
    console.log('key---', key, activeSection)

    //  if (Object.keys(props.fileReader.updatedSection).length>0 && props.fileReader.updatedSection[key][activeSection]) {
    //    const newLabels = props.fileReader.updatedSection[key][activeSection][0].comprehendMedical[entity].label
    // console.log(newLabels)
    //   setLabels(newLabels)
    //   setWordsCollection(newLabels)
  ...
  const handleSaveContent = async (
    ...
    console.log('======', tempWordsCollection)
  ...
  console.log('-content----', wordsCollection)
