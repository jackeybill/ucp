...
#             print(entity['Text'])
            x = str(entity['Text'])
#             print(x)
            entity['Value'] = int(''.join(ele for ele in x if ele.isdigit() or ele == '.'))
            if entity['Value'] > 100:
                entity['Value'] = 100
        else:
            entity['Value'] = 0
...
#                     ≥ 20 & ≤ 30
                    ...
                    if len(datas) == 0:
                        ...
                        bmi_values =''.join(ele for ele in item['TEST_VALUE'] if ele.isdigit() or ele == '.')
                        middle = 2
                        ...
                        for d in datas:
                            dd = ''.join(ele for ele in d if ele.isdigit() or ele == '.')
                            middle = 2
                            if int(dd[:middle]) > 60:
                                middle = 1
                            if len(str(dd)) >= 3:
...
#             entity['Value'] = int(''.join(ele for ele in x if ele.isdigit()))
            ...
            values = []
            for i in value_max:
                i = int(''.join(ele for ele in i if ele.isdigit() or ele =='.'))
                if i <= 100:
                    values.append(i)
            if len(values) > 0:
        ...
        if 'values' in entity and len(entity['values']) > 0:
            for item in entity['values']:
                if 'TEST_VALUE' in item:
                    ...
                    value =''.join(ele for ele in item['TEST_VALUE'] if ele.isdigit() or ele == '.')
                    if len(value) > 0:
